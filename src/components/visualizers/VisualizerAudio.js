...
function drawChromaSoundWaves(ctx, width, height, chroma, mel, beatPulse, time) {
  ...
  switch (style) {
    ...
    case 'matrix_rain':
      ...
      break;
    case 'matrix_rain_2':
      drawMatrixRain2Wave(ctx, width, height, chroma, mel, beatPulse, time);
      break;
    ...
    case 'maze_mystery':
      ...
      break;
    case 'minion_mayhem':
      drawMinionMayhemWave(ctx, width, height, chroma, mel, beatPulse, time);
      break;
    case 'terrain_3d':
    ...
    case 'vinyl_record':
      ...
      break;
    case 'lyric_flow':
      drawLyricFlowWave(ctx, width, height, chroma, mel, beatPulse, time);
      break;
    case 'layered':
    default:
...
function drawMatrixRain2Wave(ctx, width, height, chroma, mel, beatPulse, time) {
...
/**
 * Minion Mayhem 🍌 - A crowd of little yellow guys ARE the spectrum bars:
 * each one bounces to his own mel band, goggles tracking the beat, mouths
 * open on the drops, while bananas rain down and spin to the music.
 */
function drawMinionMayhemWave(ctx, width, height, chroma, mel, beatPulse, time) {
...
function drawLyricMelPulse(ctx, width, height, chroma, mel, beatPulse) {
...
function drawLyricFlowWave(ctx, width, height, chroma, mel, beatPulse, time) {
